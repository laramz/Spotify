...
When submitting it is important to note: for a certificate, each person must submit the project individually. However, this can be identical within your group. You can get more information at our first Coding Meetup on **May x, 2021**.			

This Spotify case study and the associated project guide was developed and written entirely from scratch by TechAcademy's Data Science team. Karlo Lukic developed the project in `R`, while Felix Schneider and Manuel Mair am Tinkhof developed it in `Python`.
...
Both beginners and advanced learners must have completed at least two thirds of the curriculum in order to receive the certificate. For beginners this means at least up to the course [Merging DataFrames with pandas (4h)](https://learn.datacamp.com/courses/merging-dataframes-with-pandas) (including this course) and for advanced learners at least up to the [Exploratory Data Analysis in Phyton (4h)](https://learn.datacamp.com/courses/exploratory-data-analysis-in-python) (including this course). In addition, at least two thirds of the project tasks have to be completed.
...
- [Manipulating DataFrames with pandas (4h)](https://www.datacamp.com/courses/manipulating-dataframes-with-pandas)
- [Merging DataFrames with pandas (4h)](https://www.datacamp.com/courses/merging-dataframes-with-pandas)
...
Of course, we will also go into more detail about the project and the tools that go with it. We will discuss everything you need to know during the first Coding Meetup, which will take place on **May x, 2021**. After that, the work on the project will officially begin.
